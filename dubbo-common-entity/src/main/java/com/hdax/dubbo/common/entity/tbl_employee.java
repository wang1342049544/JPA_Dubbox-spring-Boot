...
public class tbl_employee  implements Serializable {
    ...
    public com.hdax.dubbo.common.entity.tbl_department getTbl_department() {
        return tbl_department;
    }

    public void setTbl_department(com.hdax.dubbo.common.entity.tbl_department tbl_department) {
